...
class MqttService extends ChangeNotifier {
  ...
  Future<bool> connect() async {
    ...
    try {
      debugPrint('Підключення до HiveMQ (WSS:8884)...');
      ...
      debugPrint('Помилка підключення до брокера: $e');
      client!.disconnect();
    }
    return false;
  }
  ...
  void _setupSubscriptions() {
    ...
    client!.updates!.listen((List<MqttReceivedMessage<MqttMessage>> messages) {
      ...
      try {
        ...
        debugPrint('Помилка парсингу даних ($payload): $e');
      }
    });

    client!.onDisconnected = () {
      debugPrint('З’єднання з MQTT розірвано');
    };
  }

  void disconnect() {
    client?.disconnect();
    debugPrint('MQTT відключено вручну');
  }
}
